...
export interface CommunityPreviewProps {
  summaries?: CommunityEngagementProps[];
}

export const CommunityPreview = ({ summaries = COMMUNITY_SUMMARIES }: CommunityPreviewProps) => {
  return (
...
const CommunityEngagementCard = ({
  ...
  return (
    <div
      ...
      <DynamicIcon
        name={iconName}
        props={{ className: 'w-10 h-10 text-primary flex-shrink-0 mt-1' }}
      />
      <div>
