...
export interface AboutPreviewProps {
  summaries?: AboutSummary[];
}

export const AboutPreview = ({ summaries = ABOUT_SUMMARIES }: AboutPreviewProps) => {
...
const AboutSummaryCard = ({ iconName, title, text }: AboutSummary) => {
  return (
    <div className="max-w-xl h-fit card-elegant p-6">
      <DynamicIcon name={iconName} props={{ className: 'w-12 h-12 text-primary mb-4' }} />
