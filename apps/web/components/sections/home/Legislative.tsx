...
export interface LegislativePreviewProps {
  highlights?: LegislativeHighlightProps[];
}

export const LegislativePreview = ({
  highlights = LEGISLATIVE_HIGHLIGHTS,
}: LegislativePreviewProps) => {
...
const LegislativeHighlightCard = ({ iconName, title, description }: LegislativeHighlightProps) => {
  return (
    <div className="card-elegant p-6 animate-scale-in">
      <DynamicIcon name={iconName} props={{ className: 'w-10 h-10 text-primary mb-4' }} />
