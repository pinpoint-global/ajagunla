...
const UploadIcon = Upload as unknown as ComponentType<{ className?: string }>;
const CheckCircleIcon = CheckCircle2 as unknown as ComponentType<{ className?: string }>;
const XCircleIcon = XCircle as unknown as ComponentType<{ className?: string }>;
    ...
    <InputWrapper
      ...
      <>
        <div className="w-full px-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 font-inter">
          ...
          <UploadIcon className="size-6 text-dark/75 stroke-1" />
        </div>
        <input
          type="file"
  ...
  return (
    <GhostBtn type="button" className="w-full" onClick={removeFile}>
      <div className="w-full bg-gray-f2 grid items-center grid-cols-[auto_1fr_auto_auto] gap-4 border-b-2 border-dark px-2 py-2">
        <CheckCircleIcon className="size-4 text-dark" />
        ...
        <XCircleIcon className="size-4 text-dark" />
      </div>
    </GhostBtn>
  );
};
