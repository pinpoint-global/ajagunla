...
import { ComponentType, FocusEvent, ReactNode, useImperativeHandle, useRef } from 'react';
...
const CalendarIcon = Calendar as unknown as ComponentType<{ className?: string }>;
